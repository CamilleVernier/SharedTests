...
#setwd(dir="/home/vernierc/Documents/GitCamille/vl/")
#setwd(dir="/Users/raph/Downloads/++Ajeter/Camille/")

deb <- Sys.time()

source("IBD_simulation_FR_cluster.R") 
...
#IBDSimExec <- "/home/vernierc/Documents/GitCamille/vl/IBDSim"
IBDSimExec <- "/work/cvernier/Infusion/IBDSim"
