...
{
  s.test[i,] <- IBDSim_wrapper_IBD(g=theta.test[i,1],m=theta.test[i,2],habitatSize=theta.test[i,3])
}
stopCluster(cl) 
...
model1_without_Q <- regAbcrf(g~.,data=train1_without_Q,ntree=500, paral = TRUE)
pred.theta1_without_Q <- predict(model1_without_Q,test_without_Q,train1_without_Q, paral = TRUE)
MSE1_without_Q <- mean((theta.test[,1] - pred.theta1_without_Q$expectation)^2)
MSE1_without_Q

model1_without_ar_er <- regAbcrf(g~.,data=train1_without_ar_er,ntree=500, paral = TRUE)
pred.theta1_without_ar_er <- predict(model1_without_ar_er,test_without_ar_er,train1_without_ar_er, paral = TRUE)
...
model1_without_ar_er_Q <- regAbcrf(g~.,data=train1_without_ar_er_Q,ntree=500, paral = TRUE)
pred.theta1_without_ar_er_Q <- predict(model1_without_ar_er_Q,test_without_ar_er_Q,train1_without_ar_er_Q, paral = TRUE)
#pred_theta1_without_ar_er_obs <- predict(model1_without_ar_er,s_obs,train1_without_ar_er)
...
#### Paramètre m ####
model2 <- regAbcrf(m~.,data=train2,ntree=500, paral=TRUE)
...
model2_without_Q <- regAbcrf(m~.,data=train2_without_Q,ntree=500, paral = TRUE)
pred.theta2_without_Q <- predict(model2_without_Q,test_without_Q,train2_without_Q, paral = TRUE)
...
model2_without_ar_er <- regAbcrf(m~.,data=train2_without_ar_er,ntree=500, paral = TRUE)
pred.theta2_without_ar_er <- predict(model2_without_ar_er,test_without_ar_er,train2_without_ar_er, paral = TRUE)
...
model2_without_ar_er_Q <- regAbcrf(m~.,data=train2_without_ar_er_Q,ntree=500, paral = TRUE)
pred.theta2_without_ar_er_Q <- predict(model2_without_ar_er_Q,test_without_ar_er_Q,train2_without_ar_er_Q, paral = TRUE)
#pred_theta2_without_ar_er_obs <- predict(model2_without_ar_er,s_obs,train2_without_ar_er)
...
model3 <- regAbcrf(habitatsize~.,data=train3,ntree=500, paral=TRUE)
...
model3_without_Q <- regAbcrf(habitatsize~.,data=train3_without_Q,ntree=500, paral = TRUE)
pred.theta3_without_Q <- predict(model3_without_Q,test_without_Q,train3_without_Q, paral = TRUE)
...
model3_without_ar_er <- regAbcrf(habitatsize~.,data=train3_without_ar_er,ntree=500, paral = TRUE)
pred.theta3_without_ar_er <- predict(model3_without_ar_er,test_without_ar_er,train3_without_ar_er, paral = TRUE)
...
model3_without_ar_er_Q <- regAbcrf(habitatsize~.,data=train3_without_ar_er_Q,ntree=500, paral = TRUE)
pred.theta3_without_ar_er_Q <- predict(model3_without_ar_er_Q,test_without_ar_er_Q,train3_without_ar_er_Q, paral = TRUE)
#pred_theta3_without_ar_er_obs <- predict(model3_without_ar_er,s_obs,train3_without_ar_er)
...
# oob1_without_Q <- predictOOB(model1_without_Q, train1_without_Q, paral=TRUE)
# oob1_without_ar_er <- predictOOB(model1_without_ar_er, train1_without_ar_er, paral = TRUE)
# oob1_without_ar_er_Q <- predictOOB(model1_without_ar_er_Q, train1_without_ar_er_Q, paral=TRUE)
# 
...
# 
# 
# oob2 <- predictOOB(model2, train2, paral = TRUE)
# oob2_without_Q <- predictOOB(model2_without_Q, train2_without_Q, paral=TRUE)
# oob2_without_ar_er <- predictOOB(model2_without_ar_er, train2_without_ar_er, paral = TRUE)
# oob2_without_ar_er_Q <- predictOOB(model2_without_ar_er_Q, train2_without_ar_er_Q, paral=TRUE)
# 
...
# 
# 
# oob3 <- predictOOB(model3, train3, paral = TRUE)
# oob3_without_Q <- predictOOB(model3_without_Q, train3_without_Q, paral=TRUE)
# oob3_without_ar_er <- predictOOB(model3_without_ar_er, train3_without_ar_er, paral = TRUE)
# oob3_without_ar_er_Q <- predictOOB(model3_without_ar_er_Q, train3_without_ar_er_Q, paral=TRUE)
# 
...
#                          oob3$med_NMAE,oob3_without_Q$med_NMAE, oob3_without_ar_er$med_NMAE, oob3_without_ar_er_Q$med_NMAE),4,4, byrow=TRUE)
...
model1_without_ar_er <- regAbcrf(g~.,data=dr,ntree=500, paral = TRUE)
pred.theta1_without_ar_er <- predict(model1_without_ar_er,test_without_ar_er,train1_without_ar_er, paral = TRUE)
#pred_theta1_without_ar_er_obs <- predict(model1_without_ar_er,s_obs,train1_without_ar_er)
MSE1_without_ar_er <- mean((theta.test[,1] - pred.theta1_without_ar_er$expectation)^2)
MSE1_without_ar_er
